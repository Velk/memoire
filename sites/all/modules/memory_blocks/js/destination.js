(function ($) {
    Drupal.behaviors.memory_blocks_destination = {
        attach: function (context, settings) {
            ...
            $(".block-views .views-col .col-inner").mouseenter(function(){

                $(".block-views .views-col .views-field-field-img-activite .field-content > img").css("filter", "grayscale()");

                $(this).children(".views-field-field-img-activite").children(".field-content").children("img").css("filter", "none");

            });

            $(".block-views .views-col .col-inner").mouseleave(function(){
